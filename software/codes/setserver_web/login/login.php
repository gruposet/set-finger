  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="POST" action="valida.php">
        ...
        <input type="text" name="usuario" class="form-control" placeholder="Endereço de Email" required autofocus>
        
        <label for="senha" class="sr-only">Senha</label>
        <input type="password" nome="senha" class="form-control" placeholder="Senha" required>
