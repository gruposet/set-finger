...
<html lang="pt-br">
  ...
  <?php
      include_once("barra_menu_colaborador.php")
  ?>

    <div class="container theme-showcase" role="main">
      <div class="page-header text-center">
        <h1>Colaborador - GT-SET</h1>
      </div>
      ...
      <div class="table-responsive"> <!--col-md-6-->
          <table class="table table-striped">
            ...
            $din=$_SESSION['usuarioId'];
            $timestamp = strtotime("today");
            $selecao_usuarios= "SELECT * FROM history WHERE din = '$din' && timestamp >= '$timestamp' LIMIT 30";
